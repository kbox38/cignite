      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {currentStep === "basic"
              ? "Connect your LinkedIn account to start growing your presence"
              : currentStep === "dma"
              ? "Grant data access permissions for advanced analytics and insights"
          ...
          <div className="space-y-6">
              ...
              {accessToken && !dmaToken && (
                <div className="p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-800">
                    ✓ Basic access granted! Now let's enable advanced features.
                  </p>
                </div>
              )}
            </motion.div>
            ...
            >
              ...
              {dmaToken && (
                <div className="p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-800">
                    ✓ Full access granted! Redirecting to dashboard...
                  </p>
                </div>
              )}
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <Users
                    size={16}
                    className={accessToken ? "text-green-600" : "text-blue-600"}
                  />
                  <span
                    className={`text-sm ${
                      accessToken ? "text-green-700" : "text-gray-600"
                    }`}
                  >
                ...
                <div className="flex items-center space-x-2">
                  <LinkedIn
                    size={16}
                    className={dmaToken ? "text-green-600" : "text-blue-600"}
                  />
                  <span
                    className={`text-sm ${
                      dmaToken ? "text-green-700" : "text-gray-600"
                    }`}
                  >
        ...
        <p className="text-center text-xs text-gray-500">
          {currentStep === "basic"
            ...
            : currentStep === "dma"
            ? "Data access permissions are used only for analytics and insights"
